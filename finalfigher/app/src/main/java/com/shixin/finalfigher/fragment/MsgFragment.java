...
public class MsgFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        if (view == null) {
            ...
            mCreativewButton = (Button) view.findViewById(R.id.creative_btn);
            // 将技术片段设置成默认的页面
            getChildFragmentManager()
                    .beginTransaction()
                    .add(R.id.container_msg,new MsgTechFragment())
                    .commit();
            ...
            mTechButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!mTechButton.isSelected()) {
                        mTechButton.setSelected(true);
                        mCreativewButton.setSelected(false);

                        getChildFragmentManager()
                                .beginTransaction()
                                .replace(R.id.container_msg,new MsgTechFragment())
                                .commit();
                    }
                }
            });
            mCreativewButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Log.e("mCreativewButton","被点击");
                    if (!mCreativewButton.isSelected()) {
                        mCreativewButton.setSelected(true);
                        mTechButton.setSelected(false);

                        getChildFragmentManager()
                                .beginTransaction()
                                .replace(R.id.container_msg,new MsgIdeasFragment())
                                .commit();
