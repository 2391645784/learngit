...
public class PersonFragment extends Fragment {
    ...
    private RelativeLayout mFavoriteRelative;
    private RelativeLayout mOpenSourceRelative;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            ...
            mOpenSourceRelative = (RelativeLayout) view.findViewById(R.id.opensource_relativeLayout);


            mSettingRelative = (RelativeLayout) view.findViewById(R.id.setting_relativeLayout);
            mFavoriteRelative = (RelativeLayout) view.findViewById(R.id.favorite_relativeLayout);
             ...
             * 跳转到开源许可
             */
            mOpenSourceRelative.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
             ...
             * 跳转到设置设置
             */
            mSettingRelative.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
             ...
             * 跳转到收藏页面
             */
            mFavoriteRelative.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
