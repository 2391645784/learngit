...
public class SearchRecyclerViewAdapter extends RecyclerView.Adapter<SearchRecyclerViewAdapter.SearchViewHolder>{
    ...
    class SearchViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            String weixinDetailUrl = resultList.get(pos).getUrl();
            String weixinTitle = resultList.get(pos).getTitle();
            String weixinPicUrl = resultList.get(pos).getPicUrl();

            Intent intent = new Intent(activity, SearchWebActivity.class);
            intent.putExtra("weixinDetailUrl",weixinDetailUrl);
            intent.putExtra("weixinTitle",weixinTitle);
            intent.putExtra("weixinPicUrl",weixinPicUrl);
